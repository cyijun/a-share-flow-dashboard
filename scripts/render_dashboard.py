...
def main() -> int:
    ...
    css = """
:root{--ink:#15221e;--muted:#68756f;--paper:#f4f1e8;--panel:#fffdf8;--line:#ded8ca;--green:#18705a;--red:#b74337;--gold:#d0a73d;--navy:#1b2f3a}
